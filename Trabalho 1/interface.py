...
def selecionaImg():
    ...
    global imagemOriginal, larguraOriginal, alturaOriginal, arrayOriginal, imagemModificada, arrayImagemModificada
...
def executaFunc(opcao):                 #Seletor, inserir aqui as chamadas das funcoes de tratamento de imagem
    if opcao == 1:                      #Converter para YIQ
        print('1')
        arrayImagemModificada = RGBYIQ(arrayOriginal, larguraOriginal, alturaOriginal)
        imagemModificada = arrayImagem(arrayImagemModificada)
